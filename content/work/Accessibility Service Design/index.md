...
## Reflection
This is an ongoing project and planning out the next phases in collaboration with colleagues. A key consideration which I have highlighted is that the accessibility scores provided by the Ally service are algorithmically generated based on a list of requirements. This is therefore an indication of accessibility but it does not provide a complete picture. So much about accessibility is related to content such as, language used, the format of content, and tends to be very subject-specific. So the use of the Ally service and has to take place alongside larger scale cultural and institutional change in order to be truly effective.
